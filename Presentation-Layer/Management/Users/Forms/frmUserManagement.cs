...
namespace DVLD.PL.UsersManagement
{
    public partial class frmUserManagement : BaseForm
    {
        ...
        private async Task OpenAddNewUserDialog()
        {
        ...
        private async Task OpenUpdateSelectedUserDialog()
        {
        ...
        private async Task OpenDeleteSelectedUserDialog()
        {
            if (ctrlManagementDataGrid1.TryGetSelectedInt("UserID", out int id))
            {
        ...
        private async Task  OpenViewUserCardDialog()
        {
