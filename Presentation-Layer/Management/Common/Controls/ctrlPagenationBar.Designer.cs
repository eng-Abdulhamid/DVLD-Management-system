...
namespace DVLD.PL.Management
{
    partial class ctrlPagination
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnPrevPage.ButtonType = enButtonType.Secondary;
            btnPrevPage.CenterIconWithText = true;
            btnPrevPage.Cursor = Cursors.Hand;
            btnPrevPage.DisabledBorderColor = Color.FromArgb(226, 232, 240);
            btnPrevPage.DisabledEndColor = Color.FromArgb(241, 245, 249);
            btnPrevPage.DisabledStartColor = Color.FromArgb(241, 245, 249);
            btnPrevPage.DisabledTextColor = Color.FromArgb(148, 163, 184);
            ...
            btnNextPage.ButtonType = enButtonType.Secondary;
            btnNextPage.CenterIconWithText = true;
            btnNextPage.Cursor = Cursors.Hand;
            btnNextPage.DisabledBorderColor = Color.FromArgb(226, 232, 240);
            btnNextPage.DisabledEndColor = Color.FromArgb(241, 245, 249);
            btnNextPage.DisabledStartColor = Color.FromArgb(241, 245, 249);
            btnNextPage.DisabledTextColor = Color.FromArgb(148, 163, 184);
