...
namespace DVLD.PL.PeopleManagement
{
    partial class frmPeopleManagement
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnSelect.ButtonType = enButtonType.Primary;
            btnSelect.CenterIconWithText = false;
            btnSelect.Cursor = Cursors.Hand;
            btnSelect.DisabledBorderColor = Color.FromArgb(226, 232, 240);
            btnSelect.DisabledEndColor = Color.FromArgb(241, 245, 249);
            btnSelect.DisabledStartColor = Color.FromArgb(241, 245, 249);
            btnSelect.DisabledTextColor = Color.FromArgb(148, 163, 184);
