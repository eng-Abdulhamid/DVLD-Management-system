...
{
    public partial class frmDriverCard : BaseForm
    {
        ...
        {
            ctrlManagementActions1.OnEditClick += (s, e) => OpenEditPersonForm();
        }
        ...
        private void ctrlManagementActions1_OnAddClick(object sender, EventArgs e)
        {
